[assembly: WebActivatorEx.PreApplicationStartMethod
    (typeof(Database.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute
    (typeof(Database.App_Start.NinjectWebCommon), "Stop")]
namespace Database.App_Start
{
    ...
    public class NinjectWebCommon
    {
        ...
        {
            //kernel.Bind<IInsMSContext>().To<InsMSEntities>().InRequestScope();
